    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow-sm">
                <div class="card-header p-5 rounded-top">
                    <div class="d-flex w-100 justify-content-between align-items-center">
                        @if (isset($data->id) && !empty($data->id))
                            <h3 class="fw-bolder mb-0">{{ __('Edit Product Feedback') }}</h3>
                        @else
                            <h3 class="fw-bolder mb-0">{{ __('Create Product Feedback') }}</h3>
                        @endif
                        <a href="{{ route('admin.product-feedback.list') }}" class="btn btn-light btn-md">
                ...
                @php
                    $url = isset($data->id) ? route('admin.product-feedback.update', $data->id) : route('admin.product-feedback.store');
                @endphp
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-4">
                                <label for="product_id"
                                    class="form-label fw-semibold required">{{ __('Product') }}</label>
                                <select name="product_id" id="product_id"
                                    class="form-select form-select-lg @error('product_id') is-invalid @enderror" required>
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <select name="rating" id="rating"
                                    class="form-select form-select-lg @error('rating') is-invalid @enderror" required>
