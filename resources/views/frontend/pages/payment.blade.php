...
@section('frontend-content')
    ...
    <section class="cart-banner ">
        ...
        <div class="container  d-flex justify-content-between">
            <h1> Select Payment<span> Method</span> </h1>
    ...
    <section class="payment-section d-flex justify-content-center align-items-center">
        <div class="payment-card p-4">
            <!-- Heading -->
            <h3 class=" mb-4">Select Payment Method</h3>

            <!-- Payment Methods Images -->
            <div class="d-flex gap-3 mb-4 justify-content-cente align-items-center">
                <img src="{{ asset('frontend/images/master-img.png') }}" alt="Master Card" class="master-img">
                <img src="{{ asset('frontend/images/Visa-icon.png') }}" alt="PayPal" class="visa-img">
                <img src="{{ asset('frontend/images/paypal-img.jpg') }}" alt="Visa" class="paypal-img">
                <img src="{{ asset('frontend/images/chunk-img.png') }}" alt="Amex" class="chunk-img">
            </div>
            ...
            <!-- End Date & CVV -->
            <div class="d-flex gap- mt-4 wrraper">
                <div class="flex-fill">
                    <label class="form-label">End Date</label>
                    <input type="text" class="form-control payment-inputt">
                </div>
                <div class="flex-fill">
