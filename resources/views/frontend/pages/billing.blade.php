    ...
    <div id="paymentModal" class="payment-modal-overlay">
        <div class="payment-modal">
            ...
            <div class="payment-modal-footer">
                <button type="button" class="payment-modal-footer button btn-cancel"
                    id="cancelPaymentModal">Cancel</button>
                <button type="button" class="payment-modal-footer button btn-pay" id="confirmPaymentBtn">Pay
                    Now</button>
            </div>
                ...
                $.ajax({
                    ...
                    $(document).on('click', '.next-btn', function() {
                        ...
                        setTimeout(function() {
                            try {
                                ...
                                if (cardElement._implementation && cardElement
                                    ._implementation._mounted) {
                    ...
                    $('input[name="shipping_method"]').on('change', function() {
                        ...
                        $('.form-check .fw-semibold').each(function() {
                            const method = $(this).closest('.form-check').find(
                            ...
                            success: function(response) {
                                if (response.success) {
                                    ...
                                    window.location.href =
                                        "{{ route('order.details', ':id') }}".replace(
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            alert('Error creating payment intent: ' + (response.message ||
                                'Unknown error'));
                            $('#confirmPaymentBtn').prop('disabled', false).text('Pay Now');
                        }
                    },
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            alert('Payment confirmation failed: ' + (response.message ||
                                'Unknown error'));
                            $('#confirmPaymentBtn').prop('disabled', false).text('Pay Now');
                        }
                    },
