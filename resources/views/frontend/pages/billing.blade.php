                ...
                <form class="shipping-form" id="shipping_form" action="{{ route('order.save') }}" method="POST">
                    ...
                    <div class="form-check mt-4">
                        ...
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="d-flex">
                                <input class="form-check-input mt-1 me-2" type="radio" name="shipping_method" id="standardRate" value="standard" {{ old('shipping_method', 'standard') === 'standard' ? 'checked' : '' }}>
                                <label class="form-check-label" for="standardRate">Shipping cost may vary based on item size, weight, and destination. Our team will confirm the final shipping charges before dispatch.</label>
                            </div>
                    ...
                    <div class="form-check mt-4">
                        ...
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="d-flex">
                                <input class="form-check-input mt-1 me-2" type="radio" name="shipping_method" id="pickup" value="pickup" {{ old('shipping_method') === 'pickup' ? 'checked' : '' }}>
                                <label class="form-check-label" for="pickup">Place your order online and pick it up from our store. We'll notify you when it's ready.</label>
                            </div>
                ...
                <div class="order-summary-card">
                    ...
                    @forelse($cart as $item)
                        @php
                            ...
                            $itemImage = isset($item['image']) && !empty($item['image'])
...
<div id="paymentModal" class="payment-modal-overlay">
    <div class="payment-modal">
        ...
        <div class="payment-modal-footer">
            <button type="button" class="payment-modal-footer button btn-cancel" id="cancelPaymentModal">Cancel</button>
            <button type="button" class="payment-modal-footer button btn-pay" id="confirmPaymentBtn">Pay Now</button>
        </div>
        
        <div class="security-badge">
            <i class="fa fa-lock"></i> Secured by Stripe
        </div>
    </div>
</div>
...
$(document).ready(function() {
    ...
    $('.next-btn').on('click', function() {
        ...
        setTimeout(function() {
            try {
                cardElement.update({});
                console.log('Card element updated');
            } catch (error) {
                console.log('Stripe element updating:', error);
            }
        }, 200);
    });
